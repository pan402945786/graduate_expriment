...
targetFile = 'vgg16_cifar10_retrain_forget_two_kinds_finished_60_epochs.pth'

savedFiles = [
    # 'vgg16_cifar10_normal_tarin_init.pth',
    # 'vgg16_cifar10_normal_train_finish.pth',
    ...
    # 'vgg16_cifar10_retrain_forget_two_kinds_init.pth',
    # 'vgg16_cifar10_retrain_forget_two_kinds_finished_60_epochs.pth',
    # 'vgg16_cifar10_reverse_reset_conv1_before_training.pth',
