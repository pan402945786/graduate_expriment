...
print('Saving model......')
torch.save(net.state_dict(), '%s/vgg16_cifar10_retrain_forget_two_kinds_init.pth' % (args.outf))
...
if __name__ == "__main__":
    ...
    with open("vgg16_cifar10_retrain_forget_two_kinds_acc.txt", "a+") as f:
        with open("vgg16_cifar10_retrain_forget_two_kinds_log.txt", "a+")as f2:
            for epoch in range(pre_epoch+1, EPOCH+1):
                ...
                with torch.no_grad():
                    ...
                    # if epoch % 30 < 1 and pre_epoch != epoch:
                    #     print('Saving model......')
                    #     torch.save(net.state_dict(), args.outf + '/vgg16_cifar10_retrain_forget_two_kinds_'+str(epoch)+'_epochs.pth')
            ...
            print('Saving model......')
            torch.save(net.state_dict(), args.outf + '/vgg16_cifar10_retrain_forget_two_kinds_finished_'+str(epoch)+'_epochs.pth')
