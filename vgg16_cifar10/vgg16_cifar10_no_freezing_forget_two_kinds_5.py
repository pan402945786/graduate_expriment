...
savedFiles = [
    ...
    'vgg16_cifar10_reset_fc_conv14_before_training.pth',
    'vgg16_cifar10_reset_fc_conv15_before_training.pth',
    'vgg16_cifar10_reset_fc_conv16_before_training.pth',
    'vgg16_cifar10_reset_fc_conv17_before_training.pth',
]
...
if __name__ == "__main__":
    ...
    for i, item in enumerate(layer_count_list):
        ...
        with open(savedFiles[item-1] + "_no_freezing_acc.txt", "a+") as f:
            with open(savedFiles[item-1] + "_no_freezing_log.txt", "a+")as f2:
                for epoch in range(pre_epoch+1, EPOCH+1):

                    if optimizer.state_dict()['param_groups'][0]['lr'] < 0.00001:
                        break
                    ...
                    with torch.no_grad():
                        ...
                        if epoch % 20 < 1 and pre_epoch != epoch:
                            print('Saving model......')
                            torch.save(net.state_dict(), args.outf + '/' + savedFiles[item - 1] + '_no_freezing_finetuning_' + str(epoch) + '_epochs.pth')
                ...
                torch.save(net.state_dict(),
                           args.outf + '/' + savedFiles[item - 1] + '_no_freezing_forget_two_kinds_after_finetuning_' + str(EPOCH) + '_epochs.pth')
