...
# print('Saving model......')
# torch.save(net.state_dict(), '%s/init_model_r50.pth' % (args.outf))
# exit()
toLoad = {}
checkpoint = torch.load("./model/resnet50_normal_train_071_epoch.pth", map_location='cpu')
# print(checkpoint)
...
print("------------")
# checkpoint = torch.load("./model/init_model.pth", map_location='cpu')
checkpoint = torch.load("./model/resnet50_normal_init.pth", map_location='cpu')
...
initLayers = [
    ...
    #
    # "layer1.0.left.2.weight",
    # "layer1.0.left.3.weight",
    # "layer1.0.left.3.bias",
    #
    # "layer1.0.left.4.weight",
    ...
    #
    # "layer2.0.left.2.weight",
    # "layer2.0.left.3.weight",
    # "layer2.0.left.3.bias",
    #
    # "layer2.0.left.4.weight",
    ...
    #
    # "layer3.0.left.2.weight",
    # "layer3.0.left.3.weight",
    # "layer3.0.left.3.bias",
    #
    # "layer3.0.left.4.weight",
    ...
    "layer4.0.left.2.weight",
    "layer4.0.left.3.weight",
    "layer4.0.left.3.bias",

    "layer4.0.left.4.weight",
