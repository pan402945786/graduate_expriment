...
import utils
# import sys
# sys.path.append(r'D:\ww2\graduate_expriment\resnet18_vggface2\datasets')
# from VGG_Faces2 import VGG_Faces2
...
parser.add_argument('--test_img_list_file', type=str, default=r'D:\ww2\graduate_expriment\resnet18_vggface2\datasets\data\train_list2.txt',
...
#                     help='text file containing image files used for training')
# parser.add_argument('--test_img_list_file', type=str, default=r'/home/ubuntu/ml/resnet18_vggface2/datasets/data/train_list2.txt',
#                     help='text file containing image files used for validation, test or feature extraction')
...
if __name__ == "__main__":
    ...
    with open("normal_train_acc.txt", "w") as f:
        with open("normal_train_log.txt", "w")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    if epoch == 20 or epoch == 40 or epoch == 70:
                        print('Saving model......')
                    ...
                    if acc > best_acc:
                        ...
                        best_acc = acc
            print('Saving model......')
            torch.save(net.state_dict(), '%s/net_normal_20epoch_%03d.pth' % (args.outf, epoch + 1))
