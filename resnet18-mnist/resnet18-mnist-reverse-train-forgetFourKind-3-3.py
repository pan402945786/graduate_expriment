...
strucName = 'resnet18_'
datasetName = 'mnist_forget_four_kind_'
...
for paramIndex, param in enumerate(paramList):
    ...
    net.load_state_dict(checkpoint)
    fileAccName = fileName + "_forget_four_kind_after_acc.txt"
    fileLogName = fileName + "_forget_four_kind_after_log.txt"
    fileModelName = fileName + "_forget_four_kind_after_training"
    # 冻结相关层
    frozenIndex = []
    paramCount = 0
