...
strucName = 'resnet18_'
datasetName = 'mnist_forget_one_kind5_'
...
for paramIndex, param in enumerate(paramList):
    ...
    net.load_state_dict(checkpoint)
    fileAccName = fileName + "_forget_one_kind5_after_acc.txt"
    fileLogName = fileName + "_forget_one_kind5_after_log.txt"
    fileModelName = fileName + "_forget_one_kind5_after_training"
    # 冻结相关层
    frozenIndex = []
    paramCount = 0
