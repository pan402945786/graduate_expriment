...
parser.add_argument('--train_img_list_file', type=str, default=r'/home/ubuntu/ml/resnet18_vggface2/datasets/data/train_list_10.txt',
                    help='text file containing image files used for training')
parser.add_argument('--test_img_list_file', type=str, default=r'/home/ubuntu/ml/resnet18_vggface2/datasets/data/test_list_10.txt',
                    help='text file containing image files used for validation, test or feature extraction')
...
with open(train_img_list_file, 'r') as f:
    with open('train_list_10.txt', 'w') as f1:
        with open('test_list_10.txt', 'w') as f2:
