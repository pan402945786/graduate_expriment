...
if __name__ == "__main__":
    ...
    with open("acc_predict_2.txt", "w") as f:
        with open("log_predict_2.txt", "w")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    print('Saving model......')
                    str = "-"
                    torch.save(net.state_dict(), '%s/net_predict2_%s_%03d.pth' % (args.outf, str.join(selectedClassesStr),
                                                                                epoch + 1))
                    ...
                    if acc > best_acc:
                        f3 = open("best_acc_predict2.txt", "w")
