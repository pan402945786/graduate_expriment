...
later = "resnet18_vgg100_normal_init.pth"
former = "resnet18_vggface100_normal_051_epoch.pth"
paramList = generateParamsResnet18(former, later, layeredParams, False, filePath)
...
for j, param in enumerate(paramList):
    ...
    checkpoint = torch.load(filePath+former)
            ...
            with open(fileLogName, "a+")as f2:
                for epoch in range(pre_epoch, EPOCH):
                    ...
                    with torch.no_grad():
                        ...
                        if epoch % 10 < 1:
                            print('Saving model......')
                            torch.save(net.state_dict(), '%s/%s_%03d_epoch.pth' % (args.outf, fileModelName, epoch + 1))
