...
trainForgetFile = r"/train-20kinds-100counts.txt"
trainRetainFile = r"/train-80kinds-100counts.txt"
...
parser.add_argument('--dataset_dir', type=str, default=dataRoot+r'/datasets/train', help='dataset directory')
        ...
        with open("resnet18_vgg100_normal_train_log.txt", "a+")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    print('测试分类准确率为：%.3f%%, 当前学习率： %.3f, last loss: %.3f' % (100. * correct / total, optimizer.state_dict()['param_groups'][0]['lr'], lastLoss))
            ...
            print('Saving model......')
            torch.save(net.state_dict(), '%s/resnet18_vggface100_normal_60epoch_%03d.pth' % (args.outf, epoch + 1))
