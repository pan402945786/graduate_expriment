...
print('Saving model......')
torch.save(net.state_dict(), '%s/resnet18_cifar10_noraml_train_init.pth' % (args.outf))
...
if __name__ == "__main__":
    ...
    with open("resnet18_cifar10_normal_train_acc.txt", "a+") as f:
        with open("resnet18_cifar10_normal_train_log.txt", "a+")as f2:
            for epoch in range(pre_epoch+1, EPOCH+1):
                ...
                with torch.no_grad():
                    ...
                    if epoch % 5 < 1 and pre_epoch != epoch:
                        print('Saving model......')
                        torch.save(net.state_dict(), args.outf + '/resnet18_cifar10_normal_train_'+str(epoch)+'.pth')
            ...
            print('Saving model......')
            torch.save(net.state_dict(), args.outf + '/resnet18_cifar10_normal_train_finished_saving_'+str(epoch)+'.pth')
