...
print('Saving model......')
torch.save(net.state_dict(), '%s/resnet18_cifar10_forget_one_kind_init.pth' % (args.outf))
...
if __name__ == "__main__":
    ...
    selectedClasses = [0, 1, 2, 3, 4, 5, 6, 7, 8]
    selectedClassesStr = []
    ...
    with open("resnet18_cifar10_forget_one_kind_acc.txt", "a+") as f:
        with open("resnet18_cifar10_forget_one_kind_log.txt", "a+")as f2:
            for epoch in range(pre_epoch+1, EPOCH+1):
                ...
                with torch.no_grad():
                    ...
                    if epoch % 10 < 1 and pre_epoch != epoch:
                        print('Saving model......')
                        torch.save(net.state_dict(), args.outf + '/resnet18_cifar10_forget_one_kind_'+str(epoch)+'.pth')
            ...
            print('Saving model......')
            torch.save(net.state_dict(), args.outf + '/resnet18_cifar10_forget_one_kind_finished_saving_'+str(epoch)+'.pth')
