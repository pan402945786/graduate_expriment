...
initLayers = [
              ...
              "layer4.1.left.0.weight", "layer4.1.left.1.weight", "layer4.1.left.1.bias", "layer4.0.shortcut.0.weight", "layer4.0.shortcut.1.weight", "layer4.0.shortcut.1.bias",
              "layer4.0.left.3.weight", "layer4.0.left.4.weight", "layer4.0.left.4.bias", "layer4.0.left.0.weight", "layer4.0.left.1.weight", "layer4.0.left.1.bias",
              "layer3.1.left.3.weight", "layer3.1.left.4.weight", "layer3.1.left.4.bias", "layer3.1.left.0.weight", "layer3.1.left.1.weight", "layer3.1.left.1.bias", "layer3.0.shortcut.0.weight", "layer3.0.shortcut.1.weight", "layer3.0.shortcut.1.bias",
              "layer3.0.left.3.weight", "layer3.0.left.4.weight", "layer3.0.left.4.bias", "layer3.0.left.0.weight", "layer3.0.left.1.weight", "layer3.0.left.1.bias",
              "layer2.0.left.0.weight", "layer2.0.left.1.weight", "layer2.0.left.1.bias", "layer2.0.left.3.weight", "layer2.0.left.4.weight", "layer2.0.left.4.bias", "layer2.0.shortcut.0.weight", "layer2.0.shortcut.1.weight", "layer2.0.shortcut.1.bias", "layer2.1.left.0.weight", "layer2.1.left.1.weight", "layer2.1.left.1.bias", "layer2.1.left.3.weight", "layer2.1.left.4.weight", "layer2.1.left.4.bias",
              "layer1.0.left.0.weight", "layer1.0.left.1.weight", "layer1.0.left.1.bias", "layer1.0.left.3.weight", "layer1.0.left.4.weight", "layer1.0.left.4.bias", "layer1.1.left.0.weight", "layer1.1.left.1.weight", "layer1.1.left.1.bias", "layer1.1.left.3.weight", "layer1.1.left.4.weight", "layer1.1.left.4.bias",
...
params=net.state_dict()
print('Saving model......')
torch.save(net.state_dict(), '%s/net_reverse_freeze_all_layers_before_training.pth' % (args.outf))
# for k,v in params.items():
#     print(k)    #打印网络中的变量名
# print("1.0----added")
# print(params["conv1.0.weight"])
