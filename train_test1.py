...
if __name__ == "__main__":
    ...
    with open("train_test1_acc.txt", "a") as f:
        with open("train_test1_log.txt", "a")as f2:
            for epoch in range(pre_epoch, EPOCH):
                ...
                with torch.no_grad():
                    ...
                    if acc > best_acc:
                        f3 = open("train_test1_best_acc.txt", "w")
                        f3.write("EPOCH=%d,best_acc= %.3f%%" % (epoch + 1, acc))
                        f3.close()
                        best_acc = acc
            print('Saving model......')
            torch.save(net.state_dict(), '%s/train_test1_net.pth' % args.outf)
